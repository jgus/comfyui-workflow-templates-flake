{
  ...
  inputs = {
    ...
    comfyui-workflow-templates-core = {
      url = "github:jgus/comfyui-workflow-templates-core-flake/v0.3.246";
      inputs.nixpkgs.follows = "nixpkgs";
      inputs.flake-utils.follows = "flake-utils";
    ...
    comfyui-workflow-templates-media-api = {
      url = "github:jgus/comfyui-workflow-templates-media-api-flake/v0.3.79";
      inputs.nixpkgs.follows = "nixpkgs";
      inputs.flake-utils.follows = "flake-utils";
      inputs.flake-lib.follows = "flake-lib";
    };
    ...
    comfyui-workflow-templates-media-image = {
      url = "github:jgus/comfyui-workflow-templates-media-image-flake/v0.3.146";
      inputs.nixpkgs.follows = "nixpkgs";
      inputs.flake-utils.follows = "flake-utils";
      inputs.flake-lib.follows = "flake-lib";
    };
    comfyui-workflow-templates-media-other = {
      url = "github:jgus/comfyui-workflow-templates-media-other-flake/v0.3.212";
      inputs.nixpkgs.follows = "nixpkgs";
      inputs.flake-utils.follows = "flake-utils";
      inputs.flake-lib.follows = "flake-lib";
    };
